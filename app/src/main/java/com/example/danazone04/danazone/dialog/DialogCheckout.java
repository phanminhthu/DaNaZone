...
public class DialogCheckout extends BaseDialog implements View.OnClickListener {
    ...
    public DialogCheckout(Context context, Bitmap bitmap, String sl, OnDialogClickListener listener) {
        super(context);
        mListener = listener;
        this.bitmap = bitmap;
        this.sl = sl;
